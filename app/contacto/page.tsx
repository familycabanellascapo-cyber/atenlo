...
export default function Contacto() {
  return (
    <div className="max-w-prose mx-auto px-6 py-16">
      ...
      <a
        href="mailto:mikiarkanz@gmail.com"
      ...
      >
        mikiarkanz@gmail.com
      </a>
      <p className="text-muted text-sm mt-10">
        Si más adelante quieres un formulario en vez de un enlace de correo, se puede
        añadir con un servicio como Formspree sin tocar el resto de la web.
      </p>
    </div>
  );
}
